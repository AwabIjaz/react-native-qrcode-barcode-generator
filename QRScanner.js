...
export default class QRScannerView extends Component {
    ...
    render() {
        return (
            <View style={{flex: 1}}>
                <Camera
                    onBarCodeRead={(r)=>this.props.onScanResultReceived && this.props.onScanResultReceived(r)}
                    style={{flex: 1}}
                >
                    {/*绘制顶部标题栏组件*/}
                    {this.props.renderTopBarView && this.props.renderTopBarView()}
                    ...
                    {this.props.renderBottomMenuView && this.props.renderBottomMenuView()}
            </View>
        );
    }
}
