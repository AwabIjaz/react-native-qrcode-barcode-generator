    ...
    return (
      <View style={[styles.svgContainer, backgroundStyle]}>
        ...
        { typeof(this.props.text) != 'undefined' &&
          <Text style={{color: this.props.textColor, width: this.state.barCodeWidth, textAlign: 'center', fontFamily:"monospace", fontSize:getAdjustedFontSize(3)}} >{this.props.text}</Text>
        }
      </View>
    );
  }
